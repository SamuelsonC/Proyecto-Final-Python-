...
def product(request, category_slug, product_slug):
    # Se crea una instancia de la clase Cart
    cart = Cart(request)

    product = get_object_or_404(Product, category__slug=category_slug, slug=product_slug)

    # Si el método de la petición es POST, se crea una instancia del formulario AddToCartForm
    ...
    # Los productos similares se muestran de forma aleatoria
