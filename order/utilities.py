...
# Esta función crea un nuevo pedido y sus elementos de pedido asociados
def checkout(request, first_name, last_name, email, address, zipcode, place, phone, amount):
    ...
    return order
# Esta función envía un correo electrónico a los vendedores y al cliente
def notify_vendor(order):
    ...
    for vendor in order.vendors.all():
        ...
        msg.send()
# Esta función envía un correo electrónico al cliente
