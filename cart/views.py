...
# Esta función renderiza el template cart/cart.html
def cart_detail(request):
    cart = Cart(request)

    # Si el método de la petición es POST, se crea una instancia del formulario CheckoutForm
    ...
    # Si el método de la petición no es POST, se crea una instancia del formulario CheckoutForm        
    else:
        form = CheckoutForm()
...
# Esta función renderiza el template cart/success.html
def success(request):
